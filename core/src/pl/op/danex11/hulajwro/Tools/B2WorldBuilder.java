package pl.op.danex11.hulajwro.Tools;
...
import pl.op.danex11.hulajwro.sprites.Solids;
...
public class B2WorldBuilder {
    public B2WorldBuilder(World world, TiledMap map) {
        ...
        //******************************* EDGES
        // --- edge shape
        float wpx = (SpielFahre.VIRTUAL_WIDTH / SpielFahre.PPM);
        float hpx = (SpielFahre.VIRTUAL_HEIGHT / SpielFahre.PPM);
